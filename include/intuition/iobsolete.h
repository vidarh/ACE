...
#define INTUITION_IOBSOLETE_H 1
/*
** iobsolete.h for ACE Basic
**
...
** Date: 09/01/95
**
** Note: Fixed a problem with the define
**       INTUI_V36_NAMES_ONLY. It was missplaced
**       so the old defines where used.
**       Also placed a prefix to CLOSE
**       Date 12-Oct-85     Nils Sjoholm
**
*/
